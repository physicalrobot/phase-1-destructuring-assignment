...
const horseRanAway = [...farmAnimalsArr];

horseRanAway.splice(1, 1)
let [bessie, dolly, babe, little] = horseRanAway


const chickWentToCoop = [...horseRanAway]

chickWentToCoop.pop()

let [blackAndWhite, black, pink] = chickWentToCoop;
